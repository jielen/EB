...
public class EbSellerListPanel extends AbstractEditListBill implements ParentWindowAware, IAppMenuCompo {

  private String compoId = "EB_SELLER";

  private EbSellerListPanel self = this;
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        List<SearchCondition> needDisplaySearchConditonList = SearchConditionUtil.getNeedDisplaySearchConditonList(WorkEnv.getInstance()
          .getCurrUserId(), ZcSettingConstants.TAB_ID_EB_SELLER);
  ...
  private AbstractSearchConditionArea createTopConditionArea() {
    ...
    topSearchConditionArea = new SaveableSearchConditionArea(ZcSettingConstants.CONDITION_ID_EB_SELLER, null, false, defaultValueMap, null);

    return topSearchConditionArea;
  }

  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(ZcSettingConstants.TAB_ID_EB_SELLER), showingDisplays, createTopConditionArea(),
  ...
  private void doAdd() {
    new EbSellerDialog(self, new ArrayList(), this.topDataDisplay.getActiveTableDisplay().getTable().getRowCount(), topDataDisplay
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    private DataDisplay(List<TableDisplay> displays, List<TableDisplay> showingDisplays, AbstractSearchConditionArea conditionArea,
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, ZcSettingConstants.TAB_ID_EB_SELLER);
        ...
        table.addMouseListener(new MouseAdapter() {
          public void mouseClicked(MouseEvent e) {
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new EbSellerDialog(self, viewList, row, tabStatus);
            }
          }
        });
      }
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          ...
          return mc.convertToTableModel(self.ebayServiceDelegate.getEbSeller(elementConditionDto, requestMeta));
        }
  ...
  protected void setTableCellRender(JTable table) {
    ...
    AsValCellRenderer statusRender = new AsValCellRenderer(ZcSettingConstants.VS_EB_SELLER_ATTENTION_STATUS);
    SwingUtil.setTableCellRenderer(table, LangTransMeta.translate(ZcElementConstants.FIELD_EB_SELLER_ATTENTION_STATUS), statusRender);
  ...
  public static void main(String[] args) throws Exception {
    SwingUtilities.invokeLater(new Runnable() {
      public void run() {
        ...
        EbSellerListPanel bill = new EbSellerListPanel();
