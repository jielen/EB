...
import com.ufgov.gk.client.common.converter.EbSellerGroupToTableModelConverter;
...
public class EbSellerGroupListPanel extends AbstractEditListBill implements ParentWindowAware, IAppMenuCompo {

  private String compoId = "EB_SELLER_GROUP";

  private EbSellerGroupListPanel self = this;
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        List<SearchCondition> needDisplaySearchConditonList = SearchConditionUtil.getNeedDisplaySearchConditonList(WorkEnv.getInstance()
          .getCurrUserId(), ZcSettingConstants.TAB_ID_EB_SELLER_GROUP);
  ...
  private AbstractSearchConditionArea createTopConditionArea() {
    ...
    topSearchConditionArea = new SaveableSearchConditionArea(ZcSettingConstants.CONDITION_ID_EB_SELLER_GROUP, null, false, defaultValueMap, null);

    return topSearchConditionArea;
  }

  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(ZcSettingConstants.TAB_ID_EB_SELLER_GROUP), showingDisplays,
  ...
  private void doAdd() {
    new EbSellerGroupDialog(self, new ArrayList(), this.topDataDisplay.getActiveTableDisplay().getTable().getRowCount(), topDataDisplay
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    private DataDisplay(List<TableDisplay> displays, List<TableDisplay> showingDisplays, AbstractSearchConditionArea conditionArea,
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, ZcSettingConstants.TAB_ID_EB_SELLER_GROUP);
        ...
        table.addMouseListener(new MouseAdapter() {
          public void mouseClicked(MouseEvent e) {
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new EbSellerGroupDialog(self, viewList, row, tabStatus);
            }
          }
        });
      }
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          EbSellerGroupToTableModelConverter mc = new EbSellerGroupToTableModelConverter();
          return mc.convertToTableModel(self.ebayServiceDelegate.getEbSellerGroup(elementConditionDto, requestMeta));
        }
  ...
  public static void main(String[] args) throws Exception {
    SwingUtilities.invokeLater(new Runnable() {
      public void run() {
        ...
        EbSellerGroupListPanel bill = new EbSellerGroupListPanel();
