/**
 * EbEbaySiteListPanel.java
 * com.eb.client.component.ebaysite
 * Administrator
 * Jun 24, 2012
 */
...
import com.ufgov.gk.client.common.converter.EbSiteToTableModelConverter;
 ...
 *
 */
public class EbEbaySiteListPanel extends AbstractEditListBill implements ParentWindowAware, IAppMenuCompo {

  private String compoId = "EB_SITE";

  private EbEbaySiteListPanel self = this;
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        List<SearchCondition> needDisplaySearchConditonList = SearchConditionUtil.getNeedDisplaySearchConditonList(WorkEnv.getInstance()
          .getCurrUserId(), ZcSettingConstants.TAB_ID_EB_SITE);
  ...
  private AbstractSearchConditionArea createTopConditionArea() {
    ...
    topSearchConditionArea = new SaveableSearchConditionArea(ZcSettingConstants.CONDITION_ID_EB_SITE, null, false, defaultValueMap, null);

    return topSearchConditionArea;
  }

  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(ZcSettingConstants.TAB_ID_EB_SITE), showingDisplays, createTopConditionArea(),
  ...
  private void doAdd() {
    new EbEbaySiteDialog(self, new ArrayList(), this.topDataDisplay.getActiveTableDisplay().getTable().getRowCount(), topDataDisplay
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    private DataDisplay(List<TableDisplay> displays, List<TableDisplay> showingDisplays, AbstractSearchConditionArea conditionArea,
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, ZcSettingConstants.TAB_ID_EB_SITE);
        ...
        table.addMouseListener(new MouseAdapter() {
          public void mouseClicked(MouseEvent e) {
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new EbEbaySiteDialog(self, viewList, row, tabStatus);
            }
          }
        });
      }
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          EbSiteToTableModelConverter mc = new EbSiteToTableModelConverter();
          return mc.convertToTableModel(self.ebayServiceDelegate.getEbSite(elementConditionDto, requestMeta));
        }
  ...
  public static void main(String[] args) throws Exception {
    SwingUtilities.invokeLater(new Runnable() {
      public void run() {
        ...
        EbEbaySiteListPanel bill = new EbEbaySiteListPanel();
