...
public class LocalServiceFactory {
  ...
  public synchronized static Object create(String serviceName) {
    Object service = null;
    if (context == null) {
      String[] xmls = { "applicationContext_gk_secure.xml", "applicationContext_gk_base.xml", "applicationContext_gk.xml",
        "applicationContext_gk_delegate.xml", "applicationContext_wfengine.xml", "applicationContext_ebay.xml",
        "applicationContext_ebay_delegate.xml" };
