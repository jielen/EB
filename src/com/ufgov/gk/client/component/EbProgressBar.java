...
public class EbProgressBar extends JProgressBar {
  ...
  //  private String selectedBackgroundImageURL = EbComponentUtil.getImageURL("progress_select_background.png");

  //  private String unselectedBackgroundImageURL = EbComponentUtil.getImageURL("progress_unselect_background.png");

  private ImageIcon selectedBackgroundImageIcon = EbComponentUtil.getImageIcon("progress_select_background.png");

  private Image selectedBackgroundLeft = EbComponentUtil.getImage("progress_selected_left.png");

  private Image selectedBackgroundRight = EbComponentUtil.getImage("progress_selected_right.png");

  private TexturePaint selectedPaint = EbComponentUtil.createTexturePaint("progress_select_background.png");

  private TexturePaint unselectedPaint = EbComponentUtil.createTexturePaint("progress_unselect_background.png");
  ...
  private Font font = EbComponentUtil.FONT_12_BOLD;

  public EbProgressBar() {
    this(0, 0, 100);
  }

  public EbProgressBar(int min, int max) {
    this(0, min, max);
  }

  public EbProgressBar(int value, int min, int max) {
    super(min, max);
    this.setValue(value);
    init();
  }
  ...
  protected void paintComponent(Graphics g) {
    ...
    g2d.setColor(EbComponentUtil.DEFAULT_TEXT_COLOR);
  ...
  private void paintShape(Graphics2D g2d, Shape shape, Shape clip, Paint fillPaint, Color borderColor, Image leftImage, Image rightImage) {
    ...
    g2d.setStroke(EbConstant.BASIC_STROKE);
    g2d.draw(clip);
  }
