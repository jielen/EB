 ...
 */
public class DeFeeCaculator implements IEbFeeCaculate {
  ...
  EUR 25,00 - EUR 99,99 EUR 1.6

  EUR 100,00 - EUR 249,99 EUR 3.2
  ...
  public BigDecimal getFixPayPalFee(String storeType, BigDecimal itemPrice) {
    ...
    //转换为欧元
    BigDecimal b = ebu.getCurencyValue(new BigDecimal(r), ZcSettingConstants.CURENCY_USD, ZcSettingConstants.DE);
    DecimalFormat df = new DecimalFormat("#.00");
