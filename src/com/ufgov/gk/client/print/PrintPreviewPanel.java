...
public class PrintPreviewPanel extends javax.swing.JPanel implements JRHyperlinkListener
{
  ...
  private int  convertToPageIndexInCurrentJasperPrint(int pageIndex){
	...
	public PrintPreviewPanel(List jasperPrintList)
	{
		init(jasperPrintList);
	}

  private void init(List jasperPrintList) {
    setZooms();
...
//        tlbToolBar.add(btnReload);
        ...
        btnPrevious.setToolTipText("上一页");
        ...
        btnActualSize.setToolTipText("实际大小");
        ...
        btnFitPage.setToolTipText("合适大小");
        ...
        btnFitWidth.setToolTipText("合适宽度");
...
//    try {
//      
//      for(Object data:jasperPrintListParam){
//        JasperPrintManager.printReport((JasperPrint) data, false);
//      }
//
//    } catch (JRException e) {
//      logger.error(e.getMessage(), e);
//      JOptionPane.showMessageDialog(null, "打印出现异常!\n", "错误",
...
//					)
//				);
			lblStatus.setFont(lblStatus.getFont().deriveFont(12));
			lblStatus.setText("第"+(totalPageIndex+1) + "页 共"+totalPageSize+"页" );
		}
		else
		{
